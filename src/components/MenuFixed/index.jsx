...
const MenuFixed = () => {
  ...
  return (
    <div className="menu">
      <div className="menuLogo" onClick={() => history.push('/home')} >
        <img id="logo" src={Logo} alt="Logo Meta Team" />
        <p id="menuTitle">eta Team</p>
      </div>
      
      <div className="menuOptions">
      <button className= "menuButton" onClick={() => {history.push("/sobre")}}>Sobre</button>
            <button className= "menuButton" onClick={() => {history.push("/contato")}}>Contato</button>
            {isLogged() ?
            <PoweroffOutlined
